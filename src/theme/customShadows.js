...
export default function customShadows(isDarkMode) {
  const themePalette = palette(isDarkMode);
  const color = isDarkMode ? themePalette.grey[700] : themePalette.grey[500];
