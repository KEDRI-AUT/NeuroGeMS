...
class Builder {
  ...
  buildPython = () => {
    ...
    const options = [
      ...
      '--exclude-module tensorflow', // Exclude TensorFlow
      '--exclude-module torch', // Exclude Torch
      '--exclude-module torchaudio', // Exclude TensorFlow
      '--exclude-module torchvision' // Exclude Torch
    ].join(' ');
